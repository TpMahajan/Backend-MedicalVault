...
router.post("/", auth, requireDoctor, async (req, res) => {
  try {
    ...
    // Persist doctor-patient relationship for Patient Manager history.
    try {
      ...
      console.error("⚠️ Failed to persist doctor-patient link from appointment:", linkError.message);
    }
