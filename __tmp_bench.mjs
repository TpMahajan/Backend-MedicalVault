...
const IMG = '/private/tmp/claude-501/-Users-tusharmahajan-Ai-Ally-Medical-Vault/4c8d9934-1efc-44ec-a1ff-d2a194cad582/scratchpad/test-large-scan.png';
...
await bench('CURRENT eng+hin', CURRENT_DIR, 'eng+hin');
await bench('FAST    eng+hin', FAST_DIR, 'eng+hin');
await bench('CURRENT eng-only', CURRENT_DIR, 'eng');
await bench('FAST    eng-only', FAST_DIR, 'eng');
process.exit(0);
